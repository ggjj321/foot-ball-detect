  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<WebService>(
        builder: (context, videoService, child) => context
                .read<WebService>()
                .loading
            ? const Center(
                    ...
                    children: AnimationConfiguration.toStaggeredList(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: CustomPaint(
                            foregroundPainter: GoalPainter.resultMode(
                                context.read<WebService>().coordinateX,
                                context.read<WebService>().coordinateY),
                            child: Column(
                              children: [
                                for (int y = 0; y < 3; y++)
                                  Row(
                                      ...
                                      for (int x = 0; x < 4; x++)
                                        SizedBox(
                                          ...
                                          child: Consumer<GoalFieldService>(
                                            builder: (context, goalFieldService,
                                                    child) =>
                                                Container(
